    ...
    <div className="we-root">
      ...
      <div className="we-index-wrap">
        ...
        <p className="we-index-sub">
          ...
          add a caption. Aggregates accrete in <em>localStorage</em> so the room never feels empty. Use{' '}
          <Link to="/worked-examples?reset" style={{ color: 'var(--we-accent)' }}>?reset</Link> to clear a session.
        </p>
